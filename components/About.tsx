    ...
    <>
      <div className="project--container">
        <p>
          ...
          and testing, I am able to create a fully functional web application
          that meets the needs of clients. I’m motivated to use my proven
          teamwork, communication, and organizational skills to deliver
          high-quality work. I am passionate about implementing and launching
          new applications and I have the ability to translate business
